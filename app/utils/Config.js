...
//IOS全量更新地址json
export const URL_IOS_DOWNLOAD_UPDATE_JSON = "https://www.openl.cn/txw/ipa.json";
//http://m.txbet1788.com/TXW/game/forwardGame
export const RN_VERSION = 'V1.0.0';
//这里改为false就是调试模式写死了地址，打开会从json文件那里获取地址。
export const RN_REALEASE = true;
