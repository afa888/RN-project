...
import { mergeStoreData, getStoreData, LoginStateKey, UserSession } from "./AsyncStorage";
    ...
    static async queryUserInfo() {
        http.post('User/getUserInfo', null).then(res => {
            if (res.status === 10000) {
                ...
                let _agencyStatus = oData.agencyStatus == undefined ? -1 : oData.agencyStatus;
                UserSession.agencyStatus = _agencyStatus;
