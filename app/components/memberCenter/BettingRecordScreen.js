    ...
    static navigationOptions = ({navigation}) => {
        ...
        return {
            headerTitle: <View
                ...
                <Text style={{fontSize: 18, color: 'black', fontWeight: 'bold'}}>投注记录</Text></View>,
        ...
        return (
            <View>
                <View style={{
                    ...
                    <View style={{flex: 1, width: deviceValue.windowWidth / 2, marginLeft: 12}}>
                        <Text style={{color: theme_color, marginBottom: 3}}>{item.gameName}</Text>
                        <Text>{item.bettime}</Text>
                    </View>
                    <Text style={{marginRight: 6, color: theme_color}}>{item.netAmount}</Text>
...
const styles = StyleSheet.create({
    ...
    itemTextRemark: {marginRight: 12, color: 'black', padding: 3, fontSize: 12, height: 25},
    emptyView: {
        flex: 1,
        width: deviceValue.windowWidth,
