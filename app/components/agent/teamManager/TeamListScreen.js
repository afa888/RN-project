        ...
        return (
            <View style={{...styles.betTimeContainer,backgroundColor:MainTheme.theme_color}}>
                <View style={styles.renderFilterView}>
                    <Text style={{color:MainTheme.SubmitTextColor,fontSize:15}}>{this.state.agencyLevl}</Text>
                    <View style={{height:10,width:20}}></View>
                    <Text style={{color:MainTheme.AgentLevelTextColor,fontSize:12}}>代理等级</Text>
                </View>
                <TouchableOpacity style={styles.renderFilterView}
                onPress={() => this.onshowTeamList()} >
                    <Text style={{color:MainTheme.SubmitTextColor,fontSize:15}}>{this.state.directUserNum}</Text>
                    <View style={{height:10,width:20}}></View>
                    <Text style={{color:MainTheme.AgentLevelTextColor,fontSize:12}}>旗下会员</Text>
                </TouchableOpacity>

                <View style={{...styles.renderFilterView,marginRight:20}}>
                    <Text style={{color:MainTheme.SubmitTextColor,fontSize:15}}>{this.state.totalCommission}</Text>
                    <View style={{height:10,width:20}}></View>
